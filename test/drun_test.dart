...
void main() {
  ...
  group('CacheManager', () {
    test('generates consistent cache keys', () {
      ...
      final key1 = manager.generateCacheKey('pubspec content', 'dart 3.5.0', 'script content');
      final key2 = manager.generateCacheKey('pubspec content', 'dart 3.5.0', 'script content');
    ...
    test('includes architecture when requested', () {
      ...
      final key1 = manager.generateCacheKey('pubspec', 'dart 3.5.0', 'script', includeArch: false);
      final key2 = manager.generateCacheKey('pubspec', 'dart 3.5.0', 'script', includeArch: true);
